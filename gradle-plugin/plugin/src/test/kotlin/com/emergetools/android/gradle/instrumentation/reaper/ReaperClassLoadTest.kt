...
class ReaperClassLoadTest {
  ...
  fun topLong() {
    ...
    Assertions.assertEquals(
      0x0fffffffffffffffL,
      topLong(byteArrayOf(0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0f))
    )
    Assertions.assertEquals(
      0x0fcdab8967452301L,
      topLong(byteArrayOf(0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0x0f))
    )
    Assertions.assertEquals(
      -1167088121787636991L,
      topLong(byteArrayOf(0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef))
    )
    Assertions.assertEquals(
      -1167088121787636991L,
      topLong(byteArrayOf(0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xff, 0xff))
    )
  }
}
