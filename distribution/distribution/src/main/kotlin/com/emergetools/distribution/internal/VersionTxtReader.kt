...
class VersionTxtReader {
  ...
  private fun readVersionFile(): String {
    javaClass.classLoader?.getResourceAsStream("META-INF/com/emergetools/distribution/version.txt")?.use { inputStream ->
      return inputStream.bufferedReader().use { it.readText() }
    }
    throw IllegalStateException("Could not find META-INF/com/emergetools/distribution/version.txt")
  }
